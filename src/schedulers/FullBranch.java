...
public class FullBranch extends Scheduler {
	...
	public FullBranch(NetworkGenerator ng, FlowGenerator fg, int config, double ratingThreshold) {
		super(ng, fg);
