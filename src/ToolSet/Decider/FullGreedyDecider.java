 ...
 *
 */
public class FullGreedyDecider extends GreedyScheduler implements Decider {
	protected String name;

	public FullGreedyDecider(NetworkGenerator ng, FlowGenerator fg, boolean NEW_RATING) {
		super(ng, fg);
