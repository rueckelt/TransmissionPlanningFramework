...
public class EvaluationScenarioExecutionWorker implements Callable<Boolean> {
	...
	public EvaluationScenarioExecutionWorker(boolean tEST_COST_FUNCTION, boolean vISUALIZE, int time, int nets,
			int flows, int rep, String folder, boolean overwrite, boolean recalc) {
