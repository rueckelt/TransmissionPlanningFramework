...
public class Algorithm {
    ...
    public static Population evolvePopulation(Population pop) {
        ...
        Population newPopulation = new Population(pop.getAmp(), false);
    ...
    private static Individual crossover(Individual indiv1, Individual indiv2) {
      ...
      //  //Printer.printInt(newSol.getComb().getComb());
        ...
        ////Printer.printInt("\ncrossover - final" + ": ", newSol.getComb().getComb());
        return newSol;
        // [1 2 2 4 4] - [1 3 3 5 5] - 1 2 3 4 5  - 1 2 3
    }
    ...
    private static Individual tournamentSelection(Population pop) {
        ...
        Population tournament = new Population(getTournamentSize(), false);
